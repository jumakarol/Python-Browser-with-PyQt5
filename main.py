...
class Window(QMainWindow):
	def __init__(self, *args, **kwargs):
		...
		tronlite = QAction("TronLite", self)
		tronlite.setStatusTip("Go to TronLite Official Page")
		tronlite.triggered.connect(lambda: self.go_to_URL(QUrl("https://tronliteorganization.ml")))
		bookmarks_toolbar.addAction(tronlite)
		...
		linkedin.triggered.connect(lambda: self.go_to_URL(QUrl("https://tz.linkedin.com")))
...
app.setApplicationName('TronLite Web Browser')
